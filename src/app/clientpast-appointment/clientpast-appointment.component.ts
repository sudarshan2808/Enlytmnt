...
@Component({
  selector: 'app-clientpast-appointment',
  templateUrl: './clientpast-appointment.component.html',
  styleUrls: ['./clientpast-appointment.component.css']
})
export class ClientpastAppointmentComponent implements OnInit {
  ...
  allNotesList() {
    ...
    this.enlytmntservice.NotesList(formdata).subscribe(res => {
      ...
      if (res.succ) {
        ...
        this.notesdata = JSON.stringify( this.notesData);  
