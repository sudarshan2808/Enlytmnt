...
declare var $: any;
@Component({
  selector: 'app-edit-review-application',
  templateUrl: './edit-review-application.component.html',
  styleUrls: ['./edit-review-application.component.css'],
})
export class EditReviewApplicationComponent implements OnInit {
